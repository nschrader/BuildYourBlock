...
var genesisBlock = new Block(null, new Date(), [transactionGenesis]);
var blockchain = new Blockchain();
blockchain.add(genesisBlock.miner(0));
...
// Mettre tout dans la blockchain
var block = new Block(genesisBlock.id, new Date(), [Send1000AliceToBob, maTransaction]);
blockchain.add(block.miner(3));

console.log("La blockchain", blockchain);
